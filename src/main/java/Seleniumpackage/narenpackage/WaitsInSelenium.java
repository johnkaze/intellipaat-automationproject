...
public class WaitsInSelenium {
    ...
    void implicitWait(int time, TimeUnit timeUnit) {
    ...
    void launchBrowser(String browser) {
        ...
        explicitWait(5, "email"); // 500 millis, 500 ms, 500 ms
        //fluentWait(30, 5,TimeUnit.SECONDS, "//input[@name='email']");

        WebElement uId = driver.findElement(By.name("email"));
        System.out.println(uId.getAttribute("type22"));
