...
public class HandlingDragAndDrop {
	...
	public void dragAndDropOne(WebDriver driver, WebElement eleOne, WebElement eleTwo){
		Actions actions = new Actions(driver);
		actions.dragAndDrop(eleOne, eleTwo).build().perform();
	}

	public void dragAndDropTwo(WebDriver driver, WebElement eleOne, WebElement eleTwo){
		Actions actions = new Actions(driver);
		actions.clickAndHold(eleOne).moveToElement(eleTwo).release(eleTwo).build().perform();
	}
